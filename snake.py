...
def main():
    ...
    win = pygame.display.set_mode((width, height))  # Creates our screen object, a 20x20 square of side 500
    pygame.display.set_caption("Snake")

    s = snake((255, 0, 0), (10, 10))  # Creates a snake object of red color at the center of the game screen
